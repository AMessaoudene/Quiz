...
public class QuizEasy extends JFrame {
    ...
    public QuizEasy(String Name) {
        ...
        setIconImage(new ImageIcon("images/questions.png").getImage());
        setSize(600, 400);
     ...
     // Setting up key binding for Enter key to trigger 'Next' button
        nextButton.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW)
                .put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "Next");
    ...
    private JButton createStyledButton(String text) {
        ...
        if (text.equals("Previous")) {
            button.setBackground(Color.ORANGE); // Orange color for the Previous button
        } else if (text.equals("Next")) {
            button.setBackground(Color.GREEN); // Green color for the Next button
        } else {
            button.setBackground(Color.BLUE); // Default color for other buttons
        }
